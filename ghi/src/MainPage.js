...
function MainPage({ games, genre, genregames }) {
  ...
  return (
    <div className="main bg-white dark:bg-gray-800 text-black dark:text-white shadow-xl p-5">
      ...
      <TopRatedGames games={games} reviews={reviews} />

      <div className="flex justify-between">
        <div className="w-1/2 pr-2">
          <h1
            className="mb-2 text-center text-outline text-customPurple"
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    ...
                    <div className="min-w-0 flex-auto">
                      ...
                      <p className="mt-1 truncate text-xs leading-5 text-gray-500">
                        ...
                        <span className="font-semibold mb-3">
                          Rating:{" "}
                          <span style={ratingColor(topReview.rating)}>
                            {topReview.rating}
                          </span>
                        </span>
                      </p>
