...
const UserProfile = ({ userData, setUserData }) => {
  ...
  const handleSaveBackground = async (selectedBackgroundGame) => {
    ...
    localStorage.setItem(
      "selectedBackgroundGame",
      JSON.stringify(selectedBackgroundGame)
    );
  };
  ...
  return (
    <div className="main flex flex-col items-center h-full p-4 pt-8 ">
      <div
        ...
        style={{
          backgroundImage: `url(${
            selectedBackgroundGame?.game_picture || defaultBackgroundImage
          })`,
          ...
          <Card className="p-4 bg-gray-50 shadow-md h-96">
            <div className="flex flex-col md:flex-row items-center md:items-start">
              ...
              <div className="flex-grow ml-8">
                <h1 className="text-3xl font-bold mb-2 text-customPurple">
                  {currentUser.username}
                </h1>
                <p className="text-lg text-customPurple mb-1 truncate">
                  Email: {currentUser.email}
                </p>
                <div className="flex gap-4">
                  {" "}
                  {/* Add a container with a gap */}
                  <button
